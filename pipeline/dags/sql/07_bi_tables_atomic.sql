...
-- Drop old ones
DROP 
	TABLE IF EXISTS bi.bi_county_old;
DROP 
	TABLE IF EXISTS bi.bi_state_old;
DROP 
	TABLE IF EXISTS bi.bi_country_old;
...
FROM 
	bi.bi_county 
WHERE 
	population > '{{ params.county_thresh }}';
...
FROM 
	bi.bi_state 
WHERE 
	population > '{{ params.state_thresh }}';
...
FROM 
	bi.bi_country 
WHERE 
	population > '{{ params.country_thresh }}';
...
-- Drop old ones
DROP 
	TABLE IF EXISTS bi.bi_county_top_old;
DROP 
	TABLE IF EXISTS bi.bi_state_top_old;
DROP 
	TABLE IF EXISTS bi.bi_country_top_old;
